...
.code								; Indica el comienzo del segmento de código
	main:							; Etiqueta main
		...
		push 0						; Enviar un 0 a la pila		
		lea eax, msg_caption		; Cargar dirección efectiva destino, fuente, el mensaje al registro de propósito general EAX
		push eax					; Mover el contenido del registro EAX a la pila		
		lea eax, msg_txt			; Cargar el registro EAX con el mensaje
		push eax					; Mover a la pila		
		push 0						; Enviar un cero a la pila
									; en este punto la pila esta cargada con los valores (0, msg_caption, msg_txt, 0)
									; esto indica que el proceso MessageBoxA recibe como parámetros (0, msg_txt, msg_caption, 0)
